...
OBJETOS VALIDADOS: SC7/SC1/SA2/SD1/SCR/SB1/SBM dos grupos 20, 23, 06 e 08;
                   SYS_USR.
ULTIMA VALIDACAO: 02/09/2026
...
BEGIN
    ...
    (
        SELECT '20' AS GRUPO_COD, '20 - Grupo Agronelli' AS GRUPO_EMPRESA,
               C7.C7_FILIAL, C7.C7_NUM, C7.C7_FORNECE, C7.C7_LOJA,
               COALESCE(NULLIF(C7.C7_AG_STAT, ''), C1.C1_AG_STAT, '') AS C7_AG_STAT,
               ...
               C7_RESIDUO, C7_QTDACLA, C7_TIPO, C7_CONAPRO, C7.R_E_C_N_O_
        FROM dbo.SC7200 C7
        LEFT JOIN dbo.SC1200 C1
            ON C1.C1_FILIAL = C7.C7_FILIAL
           AND C1.C1_NUM = C7.C7_NUMSC
           AND C1.C1_ITEM = C7.C7_ITEMSC
           AND C1.D_E_L_E_T_ = ''
        WHERE C7.D_E_L_E_T_ = '' AND C7.C7_EMISSAO BETWEEN @MV_PAR01 AND @MV_PAR02

        UNION ALL

        SELECT '23', '23 - MTP', C7.C7_FILIAL, C7.C7_NUM, C7.C7_FORNECE, C7.C7_LOJA,
               COALESCE(C1.C1_AG_STAT, ''), C7.C7_ITEM, C7.C7_PRODUTO, C7.C7_DESCRI, C7.C7_UM,
               C7_QUANT, C7_QUJE, C7_PRECO, C7_TOTAL, C7_VLDESC, C7_LOCAL,
               C7_NUMSC, C7_DATPRF, C7_EMISSAO, C7_COND, C7_CC, C7_EMITIDO,
               C7_NUMCOT, C7_CONTRA, C7_USER, C7_SOLICIT, C7_JUSTIFI,
               C7_RESIDUO, C7_QTDACLA, C7_TIPO, C7_CONAPRO, C7.R_E_C_N_O_
        FROM dbo.SC7230 C7
        LEFT JOIN dbo.SC1230 C1
            ON C1.C1_FILIAL = C7.C7_FILIAL
           AND C1.C1_NUM = C7.C7_NUMSC
           AND C1.C1_ITEM = C7.C7_ITEMSC
           AND C1.D_E_L_E_T_ = ''
        ...
        SELECT '06', '06 - IADS', C7.C7_FILIAL, C7.C7_NUM, C7.C7_FORNECE, C7.C7_LOJA,
               COALESCE(C1.C1_AG_STAT, ''), C7.C7_ITEM, C7.C7_PRODUTO, C7.C7_DESCRI, C7.C7_UM,
               C7_QUANT, C7_QUJE, C7_PRECO, C7_TOTAL, C7_VLDESC, C7_LOCAL,
               C7_NUMSC, C7_DATPRF, C7_EMISSAO, C7_COND, C7_CC, C7_EMITIDO,
               C7_NUMCOT, C7_CONTRA, C7_USER, C7_SOLICIT, C7_JUSTIFI,
        ...
        SELECT '08', '08 - Neltech', C7.C7_FILIAL, C7.C7_NUM, C7.C7_FORNECE, C7.C7_LOJA,
               COALESCE(C1.C1_AG_STAT, ''), C7.C7_ITEM, C7.C7_PRODUTO, C7.C7_DESCRI, C7.C7_UM,
               C7_QUANT, C7_QUJE, C7_PRECO, C7_TOTAL, C7_VLDESC, C7_LOCAL,
               C7_NUMSC, C7_DATPRF, C7_EMISSAO, C7_COND, C7_CC, C7_EMITIDO,
               C7_NUMCOT, C7_CONTRA, C7_USER, C7_SOLICIT, C7_JUSTIFI,
